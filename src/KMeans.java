...
public class KMeans {
    ...
    private void assignmentStep() {
        ...
        for (int i = 0; i < m; i++) {
            ...
            assignment[i] = minLocation; // for clarity, use the number of channel here
        }
    }
        ...
        for (int c = 0; c < k; c++) {
            ...
            // after first centroid, use a weighted distribution
                ...
                for (int j = m - 1; j > 0; j--) {
                    ...
                    if (rand > weightedDistribution[j - 1] / weightedDistribution[m - 1]) { // starts at the largest bin. EDIT: not actually the largest
